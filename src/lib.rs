...
//                            };
        ...
        //create our camera controller and send it to the buffer
...
let light_render_pipeline = {
    ...
    fn update(&mut self) {
        ...
        self. light_uniform.position = ( cgmath::Quaternion::from_axis_angle((0.0, 1.0, 0.0).into(), cgmath::Deg(0.1)) * old_position).into();
